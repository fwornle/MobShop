...
/**
 * This class should be the starting point of the code, It asks the users to sign in / register, and redirects the
...
class AuthenticationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (auth.currentUser != null) {
            ...
            // already authenticated --> enter code
    ...
    // redirect successfully authenticated users to the main code
