 ...
 *
 * Or users can add the reminders and then close the code, So our code has to run in the background
 * and handle the geofencing in the background.
 * To do that you can use https://developer.android.com/reference/android/support/v4/code/JobIntentService to do that.
 *
 */
