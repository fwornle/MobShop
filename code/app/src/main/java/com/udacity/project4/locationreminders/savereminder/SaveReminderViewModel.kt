...
class SaveReminderViewModel(val app: Application, private val dataSource: ReminderDataSource) :
    ...
    //
    // note: nullable -> when the user changes the permissions from outside the code, they
    //       necessarily need to put the code into the background. This calls onClear (see below)
